...
def getmatchdaylist(n):
    ...
    # link do ligi
    driver.get("http://www.90minut.pl/liga/1/liga13062.html")
    time.sleep(0.5)
...
def mainfun():
    tm = todaymatches()
    if not tm:
        asyncio.run(send("Witam. Dzisiaj żadne mecze nie są rozgrywane w A klasie - Rzeszów II"))
        return

    # informacja o dzisiejszych meczach
    mdaymessage = "Dzisiejsze mecze: \n" + tm
